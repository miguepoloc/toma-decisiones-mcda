...
/** Red de seguridad del backoffice: si algo lanza al pintar (una respuesta inesperada de la base, un dato raro),
    ...
    <div className="wrap">
      <div className="panel">
        <div className="banner" role="alert">
          <span><b>El backoffice no pudo mostrarse.</b> Es un fallo de esta pantalla; tus datos no se tocaron.{error.digest ? ` (ref. ${error.digest})` : ''}</span>
          <span className="acts">
